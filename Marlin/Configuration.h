...
#define STRING_CONFIG_H_AUTHOR "Sebastian Roesner" // Who made the changes.
...
// Seb: For CNC
#define SPINDLE_LASER_ENA_PIN P4_28
#define SPINDLE_LASER_PWM_PIN P4_29
...
#define CUSTOM_MACHINE_NAME "CR-10S CNC"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 180, 20, 25 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 180, 300, 30, 50 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, 10, -1.739 }
...
#define Z_MIN_PROBE_PIN P1_25 // fil runout pin, used for z sensor (not bltouch)
