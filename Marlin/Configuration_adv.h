...
//#define CASE_LIGHT_ENABLE
  ...
  //#define CASE_LIGHT_USE_NEOPIXEL           // Use NeoPixel LED as case light, requires NEOPIXEL_LED.
    ...
    #define CASE_LIGHT_NEOPIXEL_COLOR { 55, 55, 55, 55 } // { Red, Green, Blue, White }
  #endif
#endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           60*5  // (seconds) Time limit before the nozzle is turned off for safety.
